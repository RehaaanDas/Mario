...
REM
REM Generated by Vivado on Mon Oct 06 20:50:19 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj CPUSandbox_vlog.prj"
call xvlog  --incr --relax -L uvm -prj CPUSandbox_vlog.prj -log xvlog.log
